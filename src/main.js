...
// 這段 wav 的 data chunk 必須有實際樣本（哪怕是靜音）——之前版本 data size 是 0，
// 導致 <audio>.play() 在 iOS 上永遠不 resolve 也不 reject（沒有內容可以「開始播放」），
// 這段解鎖形同沒執行，實測 AudioContext.resume() 因此要拖到 10 幾秒後才真正生效。
