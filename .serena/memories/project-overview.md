...
- Phase 1.5 PWA 已實作（2026-07-22，設計文件 §15 Phase 1.5）：§16 原本的「❌ 不做 PWA」已翻案，理由與快取策略在 §2／§16。**Web 版的離線可玩到這一步才第一次真的成立**（在此之前斷網是白屏）。§17 的 Phase 1.5 那 6 條也已在正式站真機驗完並打勾（2026-07-25），已找人試玩過。**還沒打勾的只剩兩批**：上一條提到的「查詞提示」那幾條（2026-07-25 新加），以及分享那 3 條（2026-07-27 新加，見下一條），除此之外 Phase 1 + 1.5 全綠。
